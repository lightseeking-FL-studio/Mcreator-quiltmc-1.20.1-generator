...
public class ${JavaModName}Potions {
	...
	<#list potions as potion>
		public static final Potion ${potion.getModElement().getRegistryNameUpper()} = Registry.register(BuiltInRegistries.POTION, new ResourceLocation("${modid}", "${potion.getModElement().getRegistryName()}"), new Potion(
