...
public abstract class ${name}Item extends ArmorItem {
	...
	public ${name}Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			return "${data.armorTextureFile!registryname}";
		}
	...
	public static class Helmet extends ${name}Item {
		...
		private static final ResourceLocation ARMOR_TEXTURE = new ResourceLocation("${modid}:textures/<#if data.helmetModelTexture?has_content && data.helmetModelTexture != "From armor">entities/${data.helmetModelTexture}<#else>models/armor/${data.armorTextureFile}_layer_1.png</#if>");
	...
	public static class Chestplate extends ${name}Item {
		...
		private static final ResourceLocation ARMOR_TEXTURE = new ResourceLocation("${modid}:textures/<#if data.bodyModelTexture?has_content && data.bodyModelTexture != "From armor">entities/${data.bodyModelTexture}<#else>models/armor/${data.armorTextureFile}_layer_1.png</#if>");
	...
	public static class Leggings extends ${name}Item {
		...
		private static final ResourceLocation ARMOR_TEXTURE = new ResourceLocation("${modid}:textures/<#if data.leggingsModelTexture?has_content && data.leggingsModelTexture != "From armor">entities/${data.leggingsModelTexture}<#else>models/armor/${data.armorTextureFile}_layer_2.png</#if>");
	...
	public static class Boots extends ${name}Item {
		...
		private static final ResourceLocation ARMOR_TEXTURE = new ResourceLocation("${modid}:textures/<#if data.bootsModelTexture?has_content && data.bootsModelTexture != "From armor">entities/${data.bootsModelTexture}<#else>models/armor/${data.armorTextureFile}_layer_1.png</#if>");
