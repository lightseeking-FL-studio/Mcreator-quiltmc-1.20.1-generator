	...
	</#if>
{
	...
	<#macro blockProperties>
		...
		<#if var_extends_class! == "WallSignBlock" || var_extends_class! == "WallHangingSignBlock">
			.dropsLike(${JavaModName}Blocks.${REGISTRYNAME})
		</#if>
	</#macro>
		...
		if(entity instanceof ServerPlayer player) {
			player.openMenu(new MenuProvider() {
				...
				@Override public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					return new ${data.guiBoundTo}Menu(id, inventory, new FriendlyByteBuf(io.netty.buffer.Unpooled.buffer()).writeBlockPos(pos));
				}
			}, pos);
		}
		</#if>
	...
	<#if data.tintType != "No tint">
		@Environment(EnvType.CLIENT) public static void blockColorLoad() {
		...
		@Environment(EnvType.CLIENT) public static void itemColorLoad() {
