...
public class ${name}Renderer implements BlockEntityRenderer<${name}BlockEntity> {
	...
	public static void register() {
		BlockEntityRendererRegistry.register(${JavaModName}BlockEntities.${REGISTRYNAME}, ${name}Renderer::new);
	}
