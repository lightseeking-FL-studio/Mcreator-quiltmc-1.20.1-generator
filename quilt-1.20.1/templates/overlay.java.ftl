...
public class ${name}Overlay {
	...
	public static void onHudRender(net.minecraft.client.gui.GuiGraphics guiGraphics, float tickDelta) {
		...
		render(guiGraphics, w, h, null);
	}
	<#else>
	public static void onScreenRender(net.minecraft.client.gui.GuiGraphics guiGraphics, int w, int h, net.minecraft.client.gui.screens.Screen screen) {
		if (screen instanceof ${generator.map(data.overlayTarget, "screens")}) {
			render(guiGraphics, w, h, screen);
		}
	}
	</#if>

	private static void render(net.minecraft.client.gui.GuiGraphics guiGraphics, int w, int h, net.minecraft.client.gui.screens.Screen screen) {
        Level world = null;
        double x = 0;
        double y = 0;
        double z = 0;
        ...
        if (<@procedureOBJToConditionCode data.displayCondition/>) {
			...
			<#list data.getComponentsOfType("EntityModel") as component>
			    if (<@procedureOBJToConditionCode component.entityModel/> instanceof LivingEntity livingEntity) {
					...
					InventoryScreen.renderEntityInInventoryFollowsAngle(guiGraphics, <@calculatePosition component=component x_offset=10 y_offset=20/>,
